...
namespace I2.Loc
{
    ...
    public static class GoogleLanguages
    {
        ...
        public static Dictionary<string, LanguageCodeDef> mLanguageDef = new Dictionary<string, LanguageCodeDef>(StringComparer.Ordinal)  
		{
			...
			{"Chinese",				new LanguageCodeDef(){PluralRule=0, Code="zh-CN", 	GoogleCode="zh-CN", HasJoinedWords=true}},
			{"Chinese/Hong Kong",	new LanguageCodeDef(){PluralRule=0, Code="zh-TW", GoogleCode="zh-TW", HasJoinedWords=true}},
			{"Chinese/Macau", 		new LanguageCodeDef(){PluralRule=0, Code="zh-CN", GoogleCode="zh-CN", HasJoinedWords=true}},
			...
			{"Chinese/Singapore", 	new LanguageCodeDef(){PluralRule=0, Code="zh-CN", GoogleCode="zh-CN", HasJoinedWords=true}},
